...
/*    public PasswordResetManager(String username){
    ...
    public String generateResetLink() throws UnsupportedEncodingException {
        ...
        System.out.println("generated by rt: " + rt.getTokenAsString());
        String s = URLEncoder.encode(rt.getTokenAsString(),StandardCharsets.UTF_8.toString());
        this.resetSalt=s;
        resetLink= "http://localhost:8081/reset?token="+s;
        return "http://localhost:8081/reset?token="+s;
    }
